...
show_xtab_plot(df, 'q03_pref_int_ext', 'q01_myrank', title.y = 'Respondent Rank')
```

<p>&nbsp;</p>

```{r q03_pref_int_ext_xtab_mytrack_plot, fig.height=4, fig.width=9}
show_xtab_plot(df, 'q03_pref_int_ext', 'q02_mytrack', title.y = 'Respondent Track')
```
...
show_comments(df$q05_affect_start_comment, 
              caption = 'Comments about q04_affect_start.')
```
...
show_comments(df$q07_affect_cost_comment, 
              caption = 'Comments about q06_affect_cost.')
```
...
show_comments(df$q09_affect_funds_comment, 
              caption = 'Comments about q08_affect_funds.')
```
...
show_comments(df$q11_affect_freeze_comment, 
              caption = 'Comments about q10_affect_freeze.')
```
...
show_comments(df$q13_ranking_comment, 
              caption = 'Comments about q12_ranking.')
```
